//
//  ZGPublishStreamCustomVideoCaptureViewController.m
...
@interface ZGPublishStreamCustomVideoCaptureViewController () <ZegoEventHandler, ZegoCustomVideoCaptureHandler, ZGCaptureDeviceDataOutputPixelBufferDelegate, UIPopoverPresentationControllerDelegate>
...
@implementation ZGPublishStreamCustomVideoCaptureViewController
...
- (void)captureDevice:(id<ZGCaptureDevice>)device didCapturedData:(CVPixelBufferRef)data presentationTimeStamp:(CMTime)timeStamp {
    ...
    CVPixelBufferRef processedPixelBuffer = [self.render renderPixelBuffer:data error:nil];
